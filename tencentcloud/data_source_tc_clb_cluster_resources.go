...
func init() {
	...
	// 		"name":                 "过滤器名称",
	// 		"筛选值s":                 "筛选值",
	// 		"cluster_resource_set": "群集资源集",
	// 		"cluster_id":           "群集ID",
	// 		"vip":                  "vip",
	// 		"load_balancer_id":     "负载平衡Id",
	// 		"idle":                 "它是空闲的吗",
	// 		"cluster_name":         "群集名称",
	// 		"isp":                  "Isp",
	// 		"clusters_zone":        "集群区域",
	// 		"master_zone":          "群集所在的可用性主区域",
	// 		"slave_zone":           "群集所在的可用性从属区域",
...
func dataSourceTencentCloudClbClusterResources() *schema.Resource {
	return &schema.Resource{
		Description: "Use this data source to query detailed information of clb cluster_resources",
