...
import tke "terraform-provider-tencentcloudenterprise/sdk/tke/v20180525"
...
const (
	TKE_FORWARD_METHOD_POST   = "POST"
	TKE_FORWARD_METHOD_GET    = "GET"
	TKE_FORWARD_METHOD_DELETE = "DELETE"
	TKE_FORWARD_METHOD_PATCH  = "PATCH"
)
