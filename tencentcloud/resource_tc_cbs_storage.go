...
func init() {
	registerResourceDescriptionProvider("cloud_cbs_storage", CNDescription{
		...
		AttributesCN: map[string]string{
			"storage_type":            "云硬盘类型",
			"storage_size":            "云硬盘大小",
			"disk_storage_pool_group": "云存储池分组",
			"charge_type":             "云硬盘计费类型",
			"prepaid_period":          "云硬盘预付费购买时长",
			"prepaid_renew_flag":      "云硬盘预付费自动续费标识",
...
func resourceTencentCloudCbsStorage() *schema.Resource {
	return &schema.Resource{
		Description: "Provides a resource to create a CBS.",
		...
		Schema: map[string]*schema.Schema{
			"storage_type": {
				...
				Description:  "Type of CBS medium. Valid values: CLOUD_BASIC: HDD cloud disk, CLOUD_PREMIUM: Premium Cloud Storage, CLOUD_SSD: SSD.",
			},
			"storage_size": {
				Type:        schema.TypeInt,
				Required:    true,
			...
			"disk_storage_pool_group": {
				Type:        schema.TypeString,
				Optional:    true,
				Description: "The pool group of CBS instance",
			},
			"prepaid_period": {
				Type:         schema.TypeInt,
				Optional:     true,
			...
			"storage_id": {
				Type:        schema.TypeString,
				Computed:    true,
				Description: "The ID of the CBS instance.",
			},
		},
	}
}
...
func resourceTencentCloudCbsStorageCreate(d *schema.ResourceData, meta interface{}) error {
	...
	request.DiskStoragePoolGroup = helper.String(d.Get("disk_storage_pool_group").(string))
...
func resourceTencentCloudCbsStorageRead(d *schema.ResourceData, meta interface{}) error {
	...
	_ = d.Set("disk_storage_pool_group", storage.DiskStoragePoolGroup)
