...
func init() {
	registerDataDescriptionProvider("cloud_tsf_business_log_configs", CNDescription{
		...
		AttributesCN: map[string]string{
			...
			"config_id":                  "配置ID",
			"config_name":                "配置名称",
			"config_path":                "配置项的日志路径。注意：此字段可能返回 null，表示取不到有效值。",
			"config_desc":                "配置项的日志描述。注意：此字段可能返回 null，表示取不到有效值。",
			"config_tags":                "配置项的日志标签。注意：此字段可能返回 null，表示取不到有效值。",
			"config_pipeline":            "配置项的日志采集管道。注意：此字段可能返回 null，表示取不到有效值。",
			"config_create_time":         "配置项的创建时间。注意：此字段可能返回 null，表示取不到有效值。",
			"config_update_time":         "配置项的更新时间。注意：此字段可能返回 null，表示取不到有效值。",
			"config_schema":              "配置项的解析规则。注意：此字段可能返回 null，表示取不到有效值。",
			"schema_type":                "解析规则类型",
			"schema_content":             "解析规则内容",
			"schema_date_format":         "解析规则格式。注意：此字段可能返回 null，表示取不到有效值。",
			"schema_multiline_pattern":   "解析规则的多行匹配规则。注意：此字段可能返回 null，表示取不到有效值。",
			"schema_create_time":         "解析规则的创建时间。注意：此字段可能返回 null，表示取不到有效值。",
			"schema_pattern_layout":      "用户自定义解析规则。注意：此字段可能返回 null，表示取不到有效值。",
			"config_associated_groups":   "配置关联的部署组。注意：此字段可能返回 null，表示取不到有效值。",
			"group_id":                   "部署组ID。注意：此字段可能返回 null，表示取不到有效值。",
			"group_name":                 "部署组名称。注意：此字段可能返回 null，表示取不到有效值。",
			"application_id":             "部署组所属应用ID。注意：此字段可能返回 null，表示取不到有效值。",
			"application_name":           "部署组所属应用名称。注意：此字段可能返回 null，表示取不到有效值。",
			"application_type":           "部署组所属应用类型。注意：此字段可能返回 null，表示取不到有效值。",
			"namespace_id":               "部署组所属命名空间ID。注意：此字段可能返回 null，表示取不到有效值。",
			"namespace_name":             "部署组所属命名空间名称。注意：此字段可能返回 null，表示取不到有效值。",
			"cluster_id":                 "部署组所属集群ID。注意：此字段可能返回 null，表示取不到有效值。",
...
func dataSourceTencentCloudTsfBusinessLogConfigsRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.cloud_tsf_business_log_configs.read")()
