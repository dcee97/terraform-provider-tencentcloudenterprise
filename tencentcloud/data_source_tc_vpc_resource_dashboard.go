...
func init() {
	registerDataDescriptionProvider("cloud_vpc_resource_dashboard", CNDescription{
		...
		AttributesCN: map[string]string{
			"vpc_ids":                "Vpc实例ID，例如Vpc-f1xjkw1b",
			"resource_dashboard_set": "资源对象列表",
			"vpc_id":                 "VPC实例ID，例如“VPC-bq4bzxpj”",
			"subnet_id":              "子网实例ID，例如子网bthucmy",
			"classic_link":           "经典链接",
			"dcg":                    "直连网关",
			"pcx":                    "对等连接",
			"ip":                     "已使用的IP总数，但CVM IP、EIP和网络探测IP除外这三种IP类型将被单独计算",
			"nat":                    "NAT网关",
			"vpngw":                  "VPN网关",
			"flow_log":               "流量日志",
			"network_detect":         "网络探测",
			...
			"lb":                     "负载平衡器",
			"cdb":                    "关系数据库",
			"cmem":                   "Memcached的TencentDB",
			"cts_db":                 "云时间序列数据库",
			"maria_db":               "MariaDB的TencentDB（TDSQL）",
			"sql_server":             "TencentDB for SQL Server",
			"postgres":               "PostgreSQL的TencentDB",
			"nas":                    "网络连接存储",
			"greenplumn":             "Snova数据仓库",
			"ckafka":                 "云卡夫卡（CKafka）",
			"grocery":                "杂货店",
			"hsm":                    "数据加密服务",
			...
			"cfs":                    "云文件存储-CFS",
			"oracle":                 "神谕",
			"elastic_search":         "ElasticSearch服务",
			"t_baas":                 "区块链服务",
			"itop":                   "Itop",
			"db_audit":               "云数据库审核",
			"cynos_db_postgres":      "Enterprise TencentDB-CynosDB for Postgres",
			"redis":                  "Redis的TencentDB",
			"mongo_db":               "用于MongoDB的TencentDB",
			"dcdb":                   "一个分布式云数据库-用于TDSQL的TencentDB",
			"cynos_db_mysql":         "一个企业级的TencentDB-CynosDB MySQL",
			"subnet":                 "子网",
			"route_table":            "路由表",
...
func dataSourceTencentCloudVpcResourceDashboard() *schema.Resource {
	return &schema.Resource{
		Description: "Use this data source to query detailed information of vpc resource_dashboard",
