...
const (
	...
	// IPV4、IPV6、IPv6FullChain
	CLB_ADDRESS_IP_VERSION_IPV4          = "IPV4"
	CLB_ADDRESS_IP_VERSION_IPV6          = "IPV6"
	CLB_ADDRESS_IP_VERSION_IPv6FullChain = "IPv6FullChain"
)
...
var CLB_ADDRESS_IP_VERSION = []string{
	CLB_ADDRESS_IP_VERSION_IPV4,
	CLB_ADDRESS_IP_VERSION_IPV6,
	CLB_ADDRESS_IP_VERSION_IPv6FullChain,
}
