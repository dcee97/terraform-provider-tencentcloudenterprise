...
func init() {
	resource.AddTestSweepers("cloud_vpc_security_group", &resource.Sweeper{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSecurityGroupExists("cloud_vpc_security_group.foo", &sgId),
					resource.TestCheckResourceAttr("cloud_vpc_security_group.foo", "name", "ci-temp-test-sg"),
					resource.TestCheckResourceAttr("cloud_vpc_security_group.foo", "description", ""),
					resource.TestCheckResourceAttr("cloud_vpc_security_group.foo", "project_id", "0"),
				),
			},
			{
				ResourceName:      "cloud_vpc_security_group.foo",
				ImportState:       true,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSecurityGroupExists("cloud_vpc_security_group.foo", &sgId),
					resource.TestCheckResourceAttr("cloud_vpc_security_group.foo", "name", "ci-temp-test-sg"),
					resource.TestCheckResourceAttr("cloud_vpc_security_group.foo", "description", "ci-temp-test-sg-desc"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSecurityGroupExists("cloud_vpc_security_group.foo", &sgId),
					resource.TestCheckResourceAttr("cloud_vpc_security_group.foo", "name", "ci-temp-test-sg-updated"),
					resource.TestCheckResourceAttr("cloud_vpc_security_group.foo", "description", "ci-temp-test-sg-desc-updated"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSecurityGroupExists("cloud_vpc_security_group.foo", &sgId),
					resource.TestCheckResourceAttr("cloud_vpc_security_group.foo", "description", ""),
					resource.TestCheckResourceAttr("cloud_vpc_security_group.foo", "tags.test", "test"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSecurityGroupExists("cloud_vpc_security_group.foo", &sgId),
					resource.TestCheckNoResourceAttr("cloud_vpc_security_group.foo", "tags.test"),
					resource.TestCheckResourceAttr("cloud_vpc_security_group.foo", "tags.abc", "abc"),
				),
			},
		},
	})
