...
func init() {
	...
	// 		"filters":            "筛选器数组，不包括TargetGroupId有效值：TargetGroupVpcId和TargetGroupName将首先使用目标组ID",
	// 		"name":               "过滤器名称",
	// 		"筛选值数组s":             "筛选值数组",
	// 		"target_group_set":   "显示的目标组的信息集",
	// 		"target_group_id":    "目标组ID",
	// 		"vpc_id":             "靶组vpcid",
	// 		"target_group_name":  "目标组名称",
	// 		"port":               "目标组的默认端口注意：此字段可能返回null，表示无法获得有效值",
	// 		"created_time":       "目标组创建时间",
	// 		"updated_time":       "目标组修改时间",
	// 		"associated_rule":    "关联规则的数组注意：此字段可能返回null，表示无法获得有效值",
	// 		"load_balancer_id":   "关联CLB实例的ID",
	// 		"listener_id":        "关联侦听器的ID",
	// 		"location_id":        "关联转发规则的ID注意：此字段可能返回null，表示无法获得有效值",
	// 		"protocol":           "关联侦听器的协议类型，如HTTP或TCP",
	// 		"domain":             "关联转发规则的域名注意：此字段可能返回null，表示无法获得有效值",
	// 		"url":                "关联转发规则的URL注意：此字段可能返回null，表示无法获得有效值",
...
func dataSourceTencentCloudClbTargetGroupList() *schema.Resource {
	return &schema.Resource{
		Description: "Use this data source to query detailed information of clb target_group_list",
