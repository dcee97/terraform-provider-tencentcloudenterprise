...
func init() {
	registerResourceDescriptionProvider("cloud_as_scaling_config", CNDescription{
		...
		AttributesCN: map[string]string{
			...
			"instance_charge_type_prepaid_period":     "实例计费类型预付费时长",
			"instance_charge_type_prepaid_renew_flag": "实例计费类型预付费自动续费标识",
			"spot_instance_type":                      "竞价实例类型",
			"spot_max_price":                          "竞价实例最高价格",
			"internet_charge_type":                    "网络计费类型",
			"internet_max_bandwidth_out":              "网络最大出带宽",
			"public_ip_assigned":                      "是否分配公网ip",
			"password":                                "密码",
			"key_ids":                                 "密钥id",
			"keep_image_login":                        "保留镜像登录设置",
			"security_group_ids":                      "安全组id",
			"enhanced_security_service":               "是否开启云安全服务",
			"enhanced_monitor_service":                "是否开启云监控服务",
			"user_data":                               "用户数据",
			"instance_tags":                           "实例标签",
			"disk_type_policy":                        "云盘类型策略",
			"cam_role_name":                           "CAM角色名称",
			"instance_name_settings":                  "实例名称设置",
			"status":                                  "启动配置状态",
			"create_time":                             "启动配置创建时间",
			"delete_with_instance":                    "指示实例终止后是否删除磁盘。默认值为“false”",
			"disk_size":                               "磁盘容量（GB）。默认值为“0”",
			"disk_type":                               "磁盘类型。有效值“CLOUD_PREMIUM”和“CLOUD_SSD”。当disk_type_policy为ORIGINAL时有效",
			"instance_name":                           "CVM实例名称",
			"instance_name_style":                     "CVM实例名称的类型。有效值“ORIGINAL”和“UNIQUE”。默认值为“ORIGINAL”",
