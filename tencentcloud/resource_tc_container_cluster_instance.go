...
func resourceTencentCloudContainerClusterInstance() *schema.Resource {
	return &schema.Resource{
		DeprecationMessage: "This resource has been deprecated in Terraform TencentCloud provider version 1.16.0. Please use 'cloud_tke_kubernetes_scale_worker' instead.",
...
func resourceTencentCloudContainerClusterInstancesRead(d *schema.ResourceData, meta interface{}) error {
	...
	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		...
		if e, ok := e.(*errors.CloudSDKError); ok {
