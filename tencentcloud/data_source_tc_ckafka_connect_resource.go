...
//			"type":                      "连接源类型",
//			"search_word":               "用于搜索的关键字",
//			"offset":                    "页面偏移量，默认值为0",
//			"limit":                     "返回数字，默认值为20，最大值为100",
//			"resource_region":           "连接源关键字查询，根据区域在本地区域的连接管理列表中查询连接（仅支持包含区域输入的连接源）",
//			"result":                    "连接源列表",
//			"total_count":               "连接源的数量",
//			"connect_resource_list":     "资源列表",
//			"resource_id":               "资源id",
//			"resource_name":             "资源名称",
//			"description":               "描述",
//			"status":                    "资源状态",
//			"create_time":               "创建时间",
//			"error_message":             "错误消息",
//			"datahub_task_count":        "与此连接源关联的Datahub任务数",
//			"current_step":              "连接源的当前步骤",
//			"task_progress":             "创建进度百分比",
//			"step_list":                 "步骤列表",
//			"dts_connect_param":         "Dts配置，当Type为Dts时返回",
//			"port":                      "Dts端口",
//			"group_id":                  "Dts消费者组的id",
//			"user_name":                 "Dts使用者组的用户名",
//			"password":                  "Dts使用者组的密码",
//			"resource":                  "Dts Id",
//			"topic":                     "Dts订阅的主题",
//			"is_update":                 "是否更新到关联的Datahub任务",
//			"mongo_db_connect_param":    "Mongo DB配置，当Type为MONGODB时返回",
//			"self_built":                "连接源是否为自建集群",
//			"service_vip":               "连接源的实例VIP，当它是实例时，它是必需的",
//			"uniq_vpc_id":               "连接源的vpc Id，当它是实例时，它是必需的",
//			"es_connect_param":          "Es配置，当类型为Es时返回",
//			"clickhouse_connect_param":  "ClickHouse配置，当Type为ClickHouse时返回",
//			"mysql_connect_param":       "Mysql配置，当Type为Mysql或TDSQL C Mysql时返回",
//			"cluster_id":                "当类型为TDSQL C_MYSQL时需要",
//			"postgre_sql_connect_param": "Postgresql配置，当Type为Postgresql或TDSQL C POSTGRESSQL时返回",
//			"maria_db_connect_param":    "Mariadb配置，当Type为Mariadb时返回",
//			"sql_server_connect_param":  "SQL Server配置，当Type为SQLSERVER时返回",
//			"ctsdb_connect_param":       "Ctsdb配置，当Type为Ctsdb时返回",
//			"doris_connect_param":       "Doris配置，当Type为Doris时返回",
//			"be_port":                   "Doris的http负载平衡连接端口，通常映射到be的8040端口",
//			"kafka_connect_param":       "Kafka配置，当Type为Kafka时返回",
//			"broker_address":            "Kafka连接的Broker地址，自建时需要",
//			"region":                    "CKafka连接源的实例资源区域，跨区域时需要",
//		},
//	})
//}
//
...
//		Description: "Use this data source to query detailed information of ckafka connect_resource",
