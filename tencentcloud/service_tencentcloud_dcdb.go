...
func (me *DcdbService) DescribeDcdbAccount(ctx context.Context, instanceId, userName string) (
	...
	log.Printf("[DEBUG] DescribeDcdbAccount len(users): %d\n", len(response.Response.Users))
	if userName != "" {
		// filter
...
func (me *DcdbService) InitDcdbDbInstance(ctx context.Context, instanceId string, params []*dcdb.DBParamValue) (initRet bool, flowId *uint64, errRet error) {
	...
	err := resource.Retry(15*readRetryTimeout, func() *resource.RetryError {
		log.Printf("[DEBUG] DescribeDcdbDbInstance instanceId: %s\n", instanceId)
		dbInstances, errResp := me.DescribeDcdbHourdbInstance(ctx, instanceId)
		if errResp != nil {
			return retryError(errResp, InternalError)
		}
		if dbInstances[0] == nil {
...
// DescribeDcdbSecurityGroup dc_sg
func (me *DcdbService) DescribeDcdbSecurityGroup(ctx context.Context, instanceId string) (securityGroup *dcdb.DescribeDBSecurityGroupsResponse, errRet error) {
	var (
		logId   = getLogId(ctx)
...
func (me *DcdbService) DescribeDcdbInstancesByFilter(ctx context.Context, params map[string]interface{}) (instances []*dcdb.DCDBInstanceInfo, errRet error) {
	...
	if response == nil || len(response.Response.Instances) < 1 {
		errRet = fmt.Errorf("no instance found")
		return
	}
...
func (me *DcdbService) DescribeDcdbFlowById(ctx context.Context, flowId *int64) (dbInstance *dcdb.DescribeFlowResponse, errRet error) {
	logId := getLogId(ctx)
...
func (me *DcdbService) DcdbDbInstanceStateRefreshFunc(flowId *int64, failStates []string) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		...
		if *flowId == 0 {
			return &dcdb.DescribeFlowResponse{}, "0", nil
		}
		...
		for _, str := range failStates {
			if strings.Contains(str, helper.Int64ToStr(*object.Response.Status)) {
				return &dcdb.DescribeFlowResponse{}, "1", nil
			}
		}

		return object, helper.Int64ToStr(*object.Response.Status), nil
	}
}
...
func (me *DcdbService) DescribeDcdbAccountPrivilegesById(ctx context.Context, ids string, dbName, aType, object, colName *string) (accountPrivileges *dcdb.DescribeAccountPrivilegesResponse, errRet error) {
	...
	accountPrivileges = response
	return
}

func (me *DcdbService) DescribeDcdbDatabases(ctx context.Context, instanceId string) (rets *dcdb.DescribeDatabasesResponse, errRet error) {
	logId := getLogId(ctx)
...
func (me *DcdbService) DescribeDcdbDBTables(ctx context.Context, instanceId string, dbName string, tableName string) (rets *dcdb.DescribeDatabaseTableResponse, errRet error) {
	logId := getLogId(ctx)
...
func (me *DcdbService) DescribeDcdbDBObjects(ctx context.Context, instanceId string, dbName string) (rets *dcdb.DescribeDatabaseObjectsResponse, errRet error) {
	logId := getLogId(ctx)
...
func (me *DcdbService) DescribeDcdbDbInstanceDetailById(ctx context.Context, instanceId string) (dedicatedClusterDbInstance *dcdb.DescribeDCDBInstanceDetailResponse, errRet error) {
	logId := getLogId(ctx)
	...
	dedicatedClusterDbInstance = response
	return
}

func (me *DcdbService) DescribeDcdbEncryptAttributesConfigById(ctx context.Context, instanceId string) (encryptAttributesConfig *dcdb.DescribeDBEncryptAttributesResponse, errRet error) {
	logId := getLogId(ctx)
	...
	encryptAttributesConfig = response
	return
}

func (me *DcdbService) DescribeDcdbDbSyncModeConfigById(ctx context.Context, instanceId string) (dbSyncModeConfig *dcdb.DescribeDBSyncModeResponse, errRet error) {
	logId := getLogId(ctx)
...
func (me *DcdbService) DcdbDbSyncModeConfigStateRefreshFunc(instanceId string, failStates []string) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		...
		return object, helper.Int64ToStr(*object.Response.IsModifying), nil
	}
}

func (me *DcdbService) DcdbInstanceStateRefreshFunc(instanceId string, failStates []string) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		ctx := contextNil
		rets, err := me.DescribeDcdbHourdbInstance(ctx, instanceId)
...
func (me *DcdbService) DcdbAccountRefreshFunc(instanceId string, userName string, failStates []string) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		...
		accounts, err := me.DescribeDcdbAccount(ctx, instanceId, userName)
