...
func init() {
	registerDataDescriptionProvider("cloud_vpc_gateway_flow_monitor_detail", CNDescription{
		...
		AttributesCN: map[string]string{
			"time_point":                      "时间点这表示将查询此分钟的详细信息例如，在“2019-02-28 18:15:20”中，将查询“18:15”的详细信息",
			"vpn_id":                          "VPN网关的实例ID，例如“VPN-ltjahce6”",
			"direct_connect_gateway_id":       "Direct Connect网关的实例ID，例如“dcg-ltjahce6”",
			"peering_connection_id":           "对等连接的实例ID，例如“pcx-ltjahce6”",
			"nat_id":                          "NAT网关的实例ID，例如“NAT-ltjahce6”",
			"order_field":                     "订单字段支持`InPkg`、`OutPkg`，`InTraffic`和`OutTraffic`",
			"order_direction":                 "订单方法升序：`ASC`，降序：`DESC`",
			"gateway_flow_monitor_detail_set": "网关流量监控详细信息",
			"private_ip_address":              "原点`IP`",
			"in_pkg":                          "入站数据包",
			"out_pkg":                         "出站数据包",
			"in_traffic":                      "入站流量，以字节为单位",
			"out_traffic":                     "出站流量，以字节为单位",
...
func dataSourceTencentCloudVpcGatewayFlowMonitorDetail() *schema.Resource {
	return &schema.Resource{
		Description: "TencentCloud VPC Gateway Flow Monitor Detail",
