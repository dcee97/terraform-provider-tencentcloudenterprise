...
func init() {
	registerDataDescriptionProvider("cloud_tsf_delivery_configs", CNDescription{
		...
		AttributesCN: map[string]string{
			"search_word":        "搜索关键字",
			"result":             "部署组信息，关联交付项的部署组信息。注意：此字段可能返回 null，表示取不到有效值。",
			"total_count":        "总数。注意：此字段可能返回 null，表示取不到有效值。",
			"content":            "内容。注意：此字段可能返回 null，表示取不到有效值。",
			"config_id":          "配置ID",
			"config_name":        "配置名称",
			"collect_path":       "采集路径。注意：此字段可能返回 null，表示取不到有效值。",
			...
			"namespace_name":     "命名空间名称。注意：此字段可能返回 null，表示取不到有效值。",
			"associate_time":     "关联时间。注意：此字段可能返回 null，表示取不到有效值。",
