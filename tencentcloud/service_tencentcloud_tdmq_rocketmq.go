...
func (me *TdmqRocketmqService) DescribeTdmqRocketmqRole(ctx context.Context, clusterId, roleName string) (role *tdmqRocketmq.Role, errRet error) {
	var (
		logId         = getLogId(ctx)
		request       = tdmqRocketmq.NewDescribeRocketMQRolesRequest()
		offset  int64 = 0
		limit   int64 = 1000
	)
	...
	response, err := me.client.UseTdmqClient().DescribeRocketMQRoles(request)
	if err != nil {
		log.Printf("[CRITAL]%s api[%s] fail, request body [%s], reason[%s]\n",
			logId, request.GetAction(), request.ToJsonString(), err.Error())
		errRet = err
...
func (me *TdmqRocketmqService) DeleteTdmqRocketmqRoleById(ctx context.Context, clusterId, roleName string) (errRet error) {
	...
	request := tdmqRocketmq.NewDeleteRocketMQRolesRequest()
	...
	ratelimit.Check(request.GetAction())
	response, err := me.client.UseTdmqClient().DeleteRocketMQRoles(request)
	if err != nil {
		errRet = err
		return err
	}
...
func (me *TdmqRocketmqService) DescribeTdmqRocketmqEnvironmentRole(ctx context.Context, clusterId, roleName, environmentId string) (environmentRoles []*tdmqRocketmq.EnvironmentRole, errRet error) {
	var (
		logId   = getLogId(ctx)
		request = tdmqRocketmq.NewDescribeRocketMQEnvironmentRolesRequest()
	)
	...
	for {
		...
		request.Limit = &pageSize
		ratelimit.Check(request.GetAction())
		response, err := me.client.UseTdmqClient().DescribeRocketMQEnvironmentRoles(request)
		if err != nil {
			log.Printf("[CRITAL]%s api[%s] fail, request body [%s], reason[%s]\n",
				logId, request.GetAction(), request.ToJsonString(), err.Error())
			errRet = err
...
func (me *TdmqRocketmqService) DeleteTdmqRocketmqEnvironmentRoleById(ctx context.Context, clusterId, roleName, environmentId string) (errRet error) {
	...
	request := tdmqRocketmq.NewDeleteRocketMQEnvironmentRolesRequest()
	...
	ratelimit.Check(request.GetAction())
	response, err := me.client.UseTdmqClient().DeleteRocketMQEnvironmentRoles(request)
	if err != nil {
		errRet = err
		return err
	}
...
func (me *TdmqService) DescribeTdmqEnvironmentAttributesByFilter(ctx context.Context, param map[string]interface{}) (environmentAttributes *tdmq.DescribeEnvironmentAttributesResponse, errRet error) {
	var (
		logId   = getLogId(ctx)
	...
	environmentAttributes = response
	return
}
...
func (me *TdmqService) DescribeRocketmqVipInstanceByFilter(ctx context.Context,
	param map[string]interface{}) (rabbitmqVipInstance []*tdmq.RocketMQVipInstance, errRet error) {
	var (
		logId   = getLogId(ctx)
...
func (me *TdmqService) DescribeTdmqVipInstanceByFilter(ctx context.Context, param map[string]interface{}) (vipInstance *tdmq.DescribeRocketMQVipInstanceDetailResponse, errRet error) {
	var (
		logId   = getLogId(ctx)
	...
	vipInstance = response
	return
}
func (me *TdmqService) DescribeTdmqMessageByFilter(ctx context.Context,
	param map[string]interface{}) (message *tdmq.DescribeRocketMQMsgResponse, errRet error) {
	var (
		logId   = getLogId(ctx)
