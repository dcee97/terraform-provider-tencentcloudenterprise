		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("cloud_cbs_disk_backup_rollback_operation.operation", "id"),
					resource.TestCheckResourceAttr("cloud_cbs_disk_backup_rollback_operation.operation", "is_rollback_completed", "true"),
				),
			},
		},
	})
...
resource "cloud_cbs_disk_backup_rollback_operation" "operation" {
