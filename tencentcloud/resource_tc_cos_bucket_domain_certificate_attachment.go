...
// TCE COS 不支持该功能
// resourceTencentCloudCspBucketDomainCertificateAttachment is used to define the resource to attach/detach the corresponding certificate for the domain name in specified cos bucket.
