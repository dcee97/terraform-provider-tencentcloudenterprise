...
//
//func init() {
//	registerDataDescriptionProvider("cloud_ckafka_topic_sync_replica", CNDescription{
//		TerraformTypeCN: "ckafka主题同步副本",
//		AttributesCN: map[string]string{
//			"instance_id":                "实例Id",
//			"topic_name":                 "主题名称",
//			"out_of_sync_replica_only":   "仅筛选未同步的副本",
//			"topic_in_sync_replica_list": "主题详细信息和副本收集",
//			"partition":                  "分区名称",
//			"leader":                     "Leader Id",
//			"replica":                    "副本集",
//			"in_sync_replica":            "以色列",
...
//		Description: "Use this data source to query detailed information of ckafka topic_sync_replica",
...
//	defer logElapsed("data_source.cloud_ckafka_topic_sync_replica.read")()
