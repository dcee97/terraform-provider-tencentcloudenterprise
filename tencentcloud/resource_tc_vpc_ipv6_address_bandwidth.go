...
func init() {
	registerResourceDescriptionProvider("cloud_vpc_ipv6_address_bandwidth", CNDescription{
		TerraformTypeCN: "创建IPv6地址带宽",
		DescriptionCN:   "提供IPv6地址带宽资源，用于创建IPv6地址带宽资源。",
		AttributesCN: map[string]string{
			"ipv6_address":               "IPv6地址",
			"internet_max_bandwidth_out": "带宽大小",
			"internet_charge_type":       "计费类型",
...
func resourceTencentCloudIpv6AddressBandwidth() *schema.Resource {
	return &schema.Resource{
		Description: "Provide a resource to create a ipv6_address_bandwidth",
