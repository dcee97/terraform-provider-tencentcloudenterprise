...
const (
	...
	CVM_PLACEMENT_GROUP_TYPE_RACK_SAME_SW = "RACK_SAME_SW"
	...
	CVM_PLACE_GROUP_STRATEGY_SPREAD          = "SPREAD"        //反亲和
	CVM_PLACE_GROUP_STRATEGY_WEAK_SPREAD     = "WEAK_SPREAD"   //弱反亲和
	CVM_PLACE_GROUP_STRATEGY_AFFINITY        = "AFFINITY"      //亲和
	CVM_PLACE_GROUP_STRATEGY_WEAK_AFFINITY   = "WEAK_AFFINITY" //弱亲和
	CVM_PLACE_GROUP_STRATEGY_FORCED_AFFINITY = "FORCED_AFFINITY"

	CVM_REBOOT_TYPE_SOFT       = "SOFT"
	CVM_REBOOT_TYPE_HARD       = "HARD"
	CVM_REBOOT_TYPE_SOFT_FIRST = "SOFT_FIRST"
)
...
var CVM_PLACEMENT_GROUP_TYPE = []string{
	...
	// CVM_PLACEMENT_GROUP_TYPE_RACK_SAME_SW,
}
...
var CVM_PLACE_GROUP_STRATEGY = []string{
	CVM_PLACE_GROUP_STRATEGY_SPREAD,
	CVM_PLACE_GROUP_STRATEGY_WEAK_SPREAD,
	CVM_PLACE_GROUP_STRATEGY_AFFINITY,
	CVM_PLACE_GROUP_STRATEGY_WEAK_AFFINITY,
}

var CVM_REBOOT_TYPE = []string{
	CVM_REBOOT_TYPE_SOFT,
	CVM_REBOOT_TYPE_HARD,
	CVM_REBOOT_TYPE_SOFT_FIRST,
}
