...
func init() {
	registerResourceDescriptionProvider("cloud_vpn_gateway", CNDescription{
		...
		AttributesCN: map[string]string{
			...
			"type":                "VPN网关类型",
			"state":               "VPN网关状态",
			"prepaid_renew_flag":  "预付费自动续费标志",
			"charge_type":         "付费模式",
			"expired_time":        "预付费到期时间",
			"is_address_blocked":  "IP是否被封堵",
			"new_purchase_plan":   "新购买的计费模式",
			"restrict_state":      "限制状态",
			"tags":                "标签",
			"create_time":         "创建时间",
			"zone":                "可用区",
			...
			"prepaid_period":      "预付费购买时长",
			"prepaid_period_unit": "预付费购买时长单位",
		},
	})
}
