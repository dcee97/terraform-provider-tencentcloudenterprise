...
layout: "cloud"
page_title: "TencentCloud: cloud_tke_kubernetes_cluster_ing"
sidebar_current: "docs-cloud-resource-tke_kubernetes_cluster_ing"
description: |-
  Provide a resource to increase instance to cluster
---

# cloud_tke_kubernetes_cluster_ing
...
* `ing_name` - (Required, String, ForceNew) ing_name.
