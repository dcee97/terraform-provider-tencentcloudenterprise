...
layout: "cloud"
page_title: "TencentCloud: cloud_tke_kubernetes_node_pool"
sidebar_current: "docs-cloud-resource-tke_kubernetes_node_pool"
description: |-
  Provide a resource to create an auto scaling group for kubernetes cluster.
---

# cloud_tke_kubernetes_node_pool

Provide a resource to create an auto scaling group for kubernetes cluster.

~> **NOTE:**  We recommend the usage of one cluster with essential worker config + node pool to manage cluster and nodes. Its a more flexible way than manage worker config with cloud_kubernetes_cluster, cloud_kubernetes_scale_worker or exist node management of `cloud_kubernetes_attachment`. Cause some unchangeable parameters of `worker_config` may cause the whole cluster resource `force new`.
