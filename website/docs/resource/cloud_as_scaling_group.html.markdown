...
layout: "cloud"
page_title: "TencentCloud: cloud_as_scaling_group"
sidebar_current: "docs-cloud-resource-as_scaling_group"
description: |-
...
* `subnet_ids` - (Required, List: [`String`]) ID list of subnet, for VPC it is required.
