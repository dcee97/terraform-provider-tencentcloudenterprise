...
layout: "cloud"
page_title: "TencentCloud: cloud_mariadb_parameters"
sidebar_current: "docs-cloud-resource-mariadb_parameters"
description: |-
  Provides a resource to create a mariadb parameters
---

# cloud_mariadb_parameters
...
```hcl
resource "cloud_mariadb_parameters" "parameters" {
...
```
$ terraform import cloud_mariadb_parameters.parameters tdsql-4pzs5b67
```
