            ...
            <ul class="nav docs-sidenav">
                ...
                <li>
                    ...
                    <ul class="nav">{{if eq .Name "Provider Data Sources"}}{{range $Resource := .DataSources}}
                        <li>
                            <a href="/docs/providers/{{$.cloud_mark}}/data_source/{{replace $Resource $.cloudPrefix ""}}.html">{{$Resource}}</a>
                        </li>{{end}}{{else}}
                        {{ if .DataSources }}<li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-auto-expand">{{range $Resource := .Resources}}
                                <li>
                                    <a href="/docs/providers/{{$.cloud_mark}}/resource/{{replace $Resource $.cloudPrefix ""}}.html">{{$Resource}}</a>
                                </li>{{end}}
                            </ul>
                        </li>{{end}}
                    </ul>
