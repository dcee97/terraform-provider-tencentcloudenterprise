...
type DescribeSaleZoneResponse struct {
	*tchttp.BaseResponse
	...
	Response *struct {
		...
		SaleZoneSet []*SaleZoneSet `json:"SaleZoneSet,omitempty" name:"SaleZoneSet"`
		// 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
		RequestId *string `json:"RequestId,omitempty" name:"RequestId"`
	} `json:"Response"`
}
...
type DescribeShrinkableDBInstanceNodeResponse struct {
	*tchttp.BaseResponse

	Response *struct {
		// 可缩减节点数

		ShrinkableNodeNum *int64 `json:"ShrinkableNodeNum,omitempty" name:"ShrinkableNodeNum"`
		// 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
		RequestId *string `json:"RequestId,omitempty" name:"RequestId"`
	} `json:"Response"`
}

func (r *DescribeShrinkableDBInstanceNodeResponse) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *DescribeShrinkableDBInstanceNodeResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type ModifyGoodsDetail struct {
	...
	OldConfig []*ChargeCommonGoodsDetailForSpec `json:"OldConfig,omitempty" name:"OldConfig"`
	// 实例希望变更后的规格配置。
...
type DescribeDBInstanceMetricQueryRequest struct {
	*tchttp.BaseRequest
	...
	TimeRanges []*TimeRange `json:"TimeRanges,omitempty" name:"TimeRanges"`
	// 指标列。
	...
	FiltersOperation *string `json:"FiltersOperation,omitempty" name:"FiltersOperation"`
	// 单一聚合。avg,count,sum,max,min。

	SingleAggregation []*string `json:"SingleAggregation,omitempty" name:"SingleAggregation"`
	// 百分位。

	Percentile []*float64 `json:"Percentile,omitempty" name:"Percentile"`
	// 百分等级。

	PercentileRanks []*float64 `json:"PercentileRanks,omitempty" name:"PercentileRanks"`
	// 基数标识。1开启，0关闭。
...
type InstanceForMonitor struct {

	// 连接大小

	ConnSize *int64 `json:"ConnSize,omitempty" name:"ConnSize"`
	// 机器类型
	...
	Rps *int64 `json:"Rps,omitempty" name:"Rps"`
	// 内存大小
	...
	StoreId *int64 `json:"StoreId,omitempty" name:"StoreId"`
	// 写入速度每秒
	...
	PayPeriod *string `json:"PayPeriod,omitempty" name:"PayPeriod"`
	// 规格ID

	StandardId *int64 `json:"StandardId,omitempty" name:"StandardId"`
	// 地域ID

	RegionId *int64 `json:"RegionId,omitempty" name:"RegionId"`
	// 版本类型

	ArchType *string `json:"ArchType,omitempty" name:"ArchType"`
	// 节点数
...
type DescribeShrinkableDBInstanceNodeRequest struct {
	*tchttp.BaseRequest
...
func (r *DescribeShrinkableDBInstanceNodeRequest) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *DescribeShrinkableDBInstanceNodeRequest) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type DescribeSaleSpecResponse struct {
	*tchttp.BaseResponse
	...
	Response *struct {
		...
		SaleSpecSet []*SaleSpecSet `json:"SaleSpecSet,omitempty" name:"SaleSpecSet"`
		// 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
		RequestId *string `json:"RequestId,omitempty" name:"RequestId"`
	} `json:"Response"`
}
