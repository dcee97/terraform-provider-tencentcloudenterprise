...
type ApplyProjectQuotaResponse struct {
	*tchttp.BaseResponse
...
func (r *ApplyProjectQuotaResponse) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *ApplyProjectQuotaResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type ApplyProjectQuotaHistory struct {
	...
	ApplyQuotaValue *uint64 `json:"ApplyQuotaValue,omitempty" name:"ApplyQuotaValue"`
	// 审批状态
...
func (r *CheckActionPermissionRequest) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *CheckActionPermissionRequest) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *CheckActionPermissionResponse) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *CheckActionPermissionResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type ApplyProjectQuotaRequest struct {
	*tchttp.BaseRequest
...
func (r *ApplyProjectQuotaRequest) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *ApplyProjectQuotaRequest) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type DescribeApplyProjectQuotaHistoryResponse struct {
	*tchttp.BaseResponse
	...
	Response *struct {
		...
		ApplyProjectQuotaHistorySet *ApplyProjectQuotaHistory `json:"ApplyProjectQuotaHistorySet,omitempty" name:"ApplyProjectQuotaHistorySet"`
		// 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
		RequestId *string `json:"RequestId,omitempty" name:"RequestId"`
	} `json:"Response"`
}

func (r *DescribeApplyProjectQuotaHistoryResponse) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *DescribeApplyProjectQuotaHistoryResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type DescribeApplyProjectQuotaHistoryRequest struct {
	*tchttp.BaseRequest
...
func (r *DescribeApplyProjectQuotaHistoryRequest) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *DescribeApplyProjectQuotaHistoryRequest) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
