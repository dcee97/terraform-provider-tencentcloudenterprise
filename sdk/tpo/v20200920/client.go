...
func NewDescribeApplyProjectQuotaHistoryRequest() (request *DescribeApplyProjectQuotaHistoryRequest) {
	request = &DescribeApplyProjectQuotaHistoryRequest{
		BaseRequest: &tchttp.BaseRequest{},
	}
	request.Init().WithApiInfo("tpo", APIVersion, "DescribeApplyProjectQuotaHistory")
	return
}

func NewDescribeApplyProjectQuotaHistoryResponse() (response *DescribeApplyProjectQuotaHistoryResponse) {
	response = &DescribeApplyProjectQuotaHistoryResponse{
		BaseResponse: &tchttp.BaseResponse{},
	}
	return
}
...
// 查询项目配额申请历史
func (c *Client) DescribeApplyProjectQuotaHistory(request *DescribeApplyProjectQuotaHistoryRequest) (response *DescribeApplyProjectQuotaHistoryResponse, err error) {
	if request == nil {
		request = NewDescribeApplyProjectQuotaHistoryRequest()
	}
	response = NewDescribeApplyProjectQuotaHistoryResponse()
	err = c.Send(request, response)
	return
}
...
func NewCheckActionPermissionRequest() (request *CheckActionPermissionRequest) {
	request = &CheckActionPermissionRequest{
		BaseRequest: &tchttp.BaseRequest{},
	}
	request.Init().WithApiInfo("tpo", APIVersion, "CheckActionPermission")
	return
}

func NewCheckActionPermissionResponse() (response *CheckActionPermissionResponse) {
	response = &CheckActionPermissionResponse{
		BaseResponse: &tchttp.BaseResponse{},
	}
	return
}
...
// 检查接口权限
func (c *Client) CheckActionPermission(request *CheckActionPermissionRequest) (response *CheckActionPermissionResponse, err error) {
	if request == nil {
		request = NewCheckActionPermissionRequest()
	}
	response = NewCheckActionPermissionResponse()
	err = c.Send(request, response)
	return
}
...
func NewApplyProjectQuotaRequest() (request *ApplyProjectQuotaRequest) {
	request = &ApplyProjectQuotaRequest{
		BaseRequest: &tchttp.BaseRequest{},
	}
	request.Init().WithApiInfo("tpo", APIVersion, "ApplyProjectQuota")
	return
}

func NewApplyProjectQuotaResponse() (response *ApplyProjectQuotaResponse) {
	response = &ApplyProjectQuotaResponse{
		BaseResponse: &tchttp.BaseResponse{},
	}
	return
}
...
// 申请项目配额
func (c *Client) ApplyProjectQuota(request *ApplyProjectQuotaRequest) (response *ApplyProjectQuotaResponse, err error) {
	if request == nil {
		request = NewApplyProjectQuotaRequest()
	}
	response = NewApplyProjectQuotaResponse()
	err = c.Send(request, response)
	return
}
