...
func NewAsymmetricSm2EncryptRequest() (request *AsymmetricSm2EncryptRequest) {
	...
	request.Init().WithApiInfo("kms", APIVersion, "AsymmetricSm2Encrypt")
	return
}
...
func NewDescribeResourceIdsRequest() (request *DescribeResourceIdsRequest) {
	request = &DescribeResourceIdsRequest{
		BaseRequest: &tchttp.BaseRequest{},
	}
	request.Init().WithApiInfo("kms", APIVersion, "DescribeResourceIds")
	return
}

func NewDescribeResourceIdsResponse() (response *DescribeResourceIdsResponse) {
	response = &DescribeResourceIdsResponse{
		BaseResponse: &tchttp.BaseResponse{},
	}
	return
}
...
// 获得资源ID列表
func (c *Client) DescribeResourceIds(request *DescribeResourceIdsRequest) (response *DescribeResourceIdsResponse, err error) {
	if request == nil {
		request = NewDescribeResourceIdsRequest()
	}
	response = NewDescribeResourceIdsResponse()
	err = c.Send(request, response)
	return
}

func NewGenerateAsymmetricKeyPairRequest() (request *GenerateAsymmetricKeyPairRequest) {
	request = &GenerateAsymmetricKeyPairRequest{
		BaseRequest: &tchttp.BaseRequest{},
	}
	request.Init().WithApiInfo("kms", APIVersion, "GenerateAsymmetricKeyPair")
	return
}

func NewGenerateAsymmetricKeyPairResponse() (response *GenerateAsymmetricKeyPairResponse) {
	response = &GenerateAsymmetricKeyPairResponse{
		BaseResponse: &tchttp.BaseResponse{},
	}
	return
}
...
// 生成非对称密钥对
func (c *Client) GenerateAsymmetricKeyPair(request *GenerateAsymmetricKeyPairRequest) (response *GenerateAsymmetricKeyPairResponse, err error) {
	if request == nil {
		request = NewGenerateAsymmetricKeyPairRequest()
	}
	response = NewGenerateAsymmetricKeyPairResponse()
	err = c.Send(request, response)
	return
}
...
func NewDescribeTSMLicensesRequest() (request *DescribeTSMLicensesRequest) {
	request = &DescribeTSMLicensesRequest{
		BaseRequest: &tchttp.BaseRequest{},
	}
	request.Init().WithApiInfo("kms", APIVersion, "DescribeTSMLicenses")
	return
}

func NewDescribeTSMLicensesResponse() (response *DescribeTSMLicensesResponse) {
	response = &DescribeTSMLicensesResponse{
		BaseResponse: &tchttp.BaseResponse{},
	}
	return
}
...
func (c *Client) DescribeTSMLicenses(request *DescribeTSMLicensesRequest) (response *DescribeTSMLicensesResponse, err error) {
	if request == nil {
		request = NewDescribeTSMLicensesRequest()
	}
	response = NewDescribeTSMLicensesResponse()
	err = c.Send(request, response)
	return
}
