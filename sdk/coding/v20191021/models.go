...
type DescribePackageListResponse struct {
	*tchttp.BaseResponse
	...
	Response *struct {
		...
		InstanceSet []*ArtifactPackage `json:"InstanceSet,omitempty" name:"InstanceSet"`
		// 请求页
...
type CreateJobRequest struct {
	*tchttp.BaseRequest
	...
	TriggerMethods []*uint64 `json:"TriggerMethods,omitempty" name:"TriggerMethods"`
	// 0|1|2
	...
	CachePaths []*CIJobCachePath `json:"CachePaths,omitempty" name:"CachePaths"`
	// 环境变量配置

	Envs []*CIJobEnv `json:"Envs,omitempty" name:"Envs"`
	// 针对 CRON triggerMethod 的 schedule 规则配置, 暂只用于添加

	Schedules []*CIJobSchedule `json:"Schedules,omitempty" name:"Schedules"`
	// 不管构建成功还是失败总是通知的用户

	AlwaysUserIds []*uint64 `json:"AlwaysUserIds,omitempty" name:"AlwaysUserIds"`
	// 仅构建失败时要通知的用户

	BuildFailIds []*uint64 `json:"BuildFailIds,omitempty" name:"BuildFailIds"`
}
...
type TriggerBuildRequest struct {
	*tchttp.BaseRequest
	...
	Params []*CIJobEnv `json:"Params,omitempty" name:"Params"`
	// Job ID
...
type DescribeJobsResponse struct {
	*tchttp.BaseResponse
	...
	Response *struct {
		...
		JobSet []*CIJob `json:"JobSet,omitempty" name:"JobSet"`
		// 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
		RequestId *string `json:"RequestId,omitempty" name:"RequestId"`
	} `json:"Response"`
}
...
type CIBuildPage struct {

	// 构建列表

	Builds []*CIBuild `json:"Builds,omitempty" name:"Builds"`
	// 请求页
	...
	TotalRow *uint64 `json:"TotalRow,omitempty" name:"TotalRow"`
}
...
type CIJobTest struct {
	...
	TriggerMethods []*string `json:"TriggerMethods,omitempty" name:"TriggerMethods"`
	// 代码更新触发匹配规则
...
type DescribeRepositoryListResponse struct {
	*tchttp.BaseResponse
	...
	Response *struct {
		...
		InstanceSet []*ArtifactRepository `json:"InstanceSet,omitempty" name:"InstanceSet"`
		// 请求页
...
type DescribeVersionListResponse struct {
	*tchttp.BaseResponse
	...
	Response *struct {
		...
		InstanceSet []*ArtifactVersion `json:"InstanceSet,omitempty" name:"InstanceSet"`
		// 请求页
...
type DescribeListBuildResponse struct {
	*tchttp.BaseResponse
	...
	Response *struct {
		...
		InstanceSet []*CIBuild `json:"InstanceSet,omitempty" name:"InstanceSet"`
		// 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
		RequestId *string `json:"RequestId,omitempty" name:"RequestId"`
	} `json:"Response"`
}
