...
type DescribeNatFwInstanceWithRegionResponse struct {
	*tchttp.BaseResponse
	...
	Response *struct {
		...
		NatinsLst []*NatFwInstance `json:"NatInsList,omitempty" name:"NatInsList"`
		// 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
		RequestId *string `json:"RequestId,omitempty" name:"RequestId"`
	} `json:"Response"`
}
...
type DescribeNatFwInstancesInfoResponse struct {
	*tchttp.BaseResponse
	...
	Response *struct {
		...
		NatInsList []*NatInstanceInfo `json:"NatInsListInsList,omitempty" name:"NatInsLiNatInsList"`
		// nat 防火墙个数
...
type ModifyNatFwInstanceRequest struct {
	*tchttp.BaseRequest
...
func (r *ModifyNatFwInstanceRequest) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *ModifyNatFwInstanceRequest) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}

type ModifyNatFwInstanceResponse struct {
	*tchttp.BaseResponse
	Response *struct {
		// 0 正常
		// -1 异常
...
func (r *ModifyNatFwInstanceResponse) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *ModifyNatFwInstanceResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}

type DeleteNatInstanceRequest struct {
	*tchttp.BaseRequest
	// NAT防火墙实例ID
	NatInstanceId *string `json:"NatInstanceId,omitnil,omitempty" name:"NatInstanceId"`
}

func (r *DeleteNatInstanceRequest) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *DeleteNatInstanceRequest) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}

type DeleteNatInstanceResponse struct {
	*tchttp.BaseResponse
	Response *struct {
		RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
	}
...
func (r *DeleteNatInstanceResponse) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *DeleteNatInstanceResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
