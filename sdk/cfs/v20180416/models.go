...
type UpdateCfsFileSystemSizeLimitRequest struct {
	*tchttp.BaseRequest
	...
	// 文件系统容量限制大小，输入范围1-1073741824, 单位为GB
...
type QueryAvailableZoneInfoResponse struct {
	*tchttp.BaseResponse
...
func (r *QueryAvailableZoneInfoResponse) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *QueryAvailableZoneInfoResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}

type QueryCfsKmsKeysRequest struct {
	*tchttp.BaseRequest
}

func (r *QueryCfsKmsKeysRequest) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *QueryCfsKmsKeysRequest) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}

type QueryCfsPGroupResponse struct {
	*tchttp.BaseResponse

	Response *struct {
		// 权限组信息列表

		PGrouplist []*PGroups `json:"PGrouplist,omitempty" name:"PGrouplist"`
		// 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
		RequestId *string `json:"RequestId,omitempty" name:"RequestId"`
	} `json:"Response"`
}

func (r *QueryCfsPGroupResponse) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *QueryCfsPGroupResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type QueryCfsFileSystemResponse struct {
	*tchttp.BaseResponse
...
func (r *QueryCfsFileSystemResponse) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *QueryCfsFileSystemResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type QueryCfsServiceStatusRequest struct {
	*tchttp.BaseRequest
}

func (r *QueryCfsServiceStatusRequest) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *QueryCfsServiceStatusRequest) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type QueryCfsRuleResponse struct {
	*tchttp.BaseResponse

	Response *struct {
		// 权限组规则列表

		RuleList []*PGroupRules `json:"RuleList,omitempty" name:"RuleList"`
		// 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
		RequestId *string `json:"RequestId,omitempty" name:"RequestId"`
	} `json:"Response"`
}

func (r *QueryCfsRuleResponse) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *QueryCfsRuleResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type QueryCfsKmsKeysResponse struct {
	*tchttp.BaseResponse

	Response *struct {
		// KmsKey列表

		CfsKmsKeys []*CfsKmsKeys `json:"CfsKmsKeys,omitempty" name:"CfsKmsKeys"`
		// 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
		RequestId *string `json:"RequestId,omitempty" name:"RequestId"`
	} `json:"Response"`
}

func (r *QueryCfsKmsKeysResponse) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *QueryCfsKmsKeysResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type QueryMountTargetsWithRegionRequest struct {
	*tchttp.BaseRequest
}

func (r *QueryMountTargetsWithRegionRequest) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *QueryMountTargetsWithRegionRequest) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type QueryCfsPGroupRequest struct {
	*tchttp.BaseRequest
...
func (r *QueryCfsPGroupRequest) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *QueryCfsPGroupRequest) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type QueryCfsFileSystemRequest struct {
	*tchttp.BaseRequest
...
func (r *QueryCfsFileSystemRequest) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *QueryCfsFileSystemRequest) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}

type QueryMountTargetsWithRegionResponse struct {
	*tchttp.BaseResponse
...
func (r *QueryMountTargetsWithRegionResponse) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *QueryMountTargetsWithRegionResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type UpdateCfsRuleRequest struct {
	*tchttp.BaseRequest
	...
	AuthClientIp *string `json:"AuthClientIp,omitempty" name:"AuthClientIp"`
	// 读写权限, 可选参数：ro, rw。ro为只读，rw为读写

	RWPermission *string `json:"RWPermission,omitempty" name:"RWPermission"`
	// 用户权限，可选参数：all_squash，no_all_squash，root_squash，no_root_squash。其中all_squash为所有访问用户都会被映射为匿名用户或用户组；no_all_squash为访问用户会先与本机用户匹配，匹配失败后再映射为匿名用户或用户组；root_squash为将来访的root用户映射为匿名用户或用户组；no_root_squash为来访的root用户保持root帐号权限。
...
type QueryCfsServiceStatusResponse struct {
	*tchttp.BaseResponse

	Response *struct {
		// 该用户当前CFS服务的状态，none为未开通，creating为开通中，created为已开通
...
func (r *QueryCfsServiceStatusResponse) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *QueryCfsServiceStatusResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}

type QueryAvailableZoneInfoRequest struct {
	*tchttp.BaseRequest
}

func (r *QueryAvailableZoneInfoRequest) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *QueryAvailableZoneInfoRequest) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type QueryCfsRuleRequest struct {
	*tchttp.BaseRequest
...
func (r *QueryCfsRuleRequest) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *QueryCfsRuleRequest) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}

type QueryMountTargetResponse struct {
	*tchttp.BaseResponse
...
func (r *QueryMountTargetResponse) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *QueryMountTargetResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type QueryMountTargetRequest struct {
	*tchttp.BaseRequest
...
func (r *QueryMountTargetRequest) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *QueryMountTargetRequest) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
