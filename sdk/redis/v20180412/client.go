...
func NewOfflineResourcePoolRequest() (request *OfflineResourcePoolRequest) {
	request = &OfflineResourcePoolRequest{
		BaseRequest: &tchttp.BaseRequest{},
	}
	request.Init().WithApiInfo("redis", APIVersion, "OfflineResourcePool")
	return
}

func NewOfflineResourcePoolResponse() (response *OfflineResourcePoolResponse) {
	response = &OfflineResourcePoolResponse{
		BaseResponse: &tchttp.BaseResponse{},
	}
	return
}
...
// 下线资源池
func (c *Client) OfflineResourcePool(request *OfflineResourcePoolRequest) (response *OfflineResourcePoolResponse, err error) {
	if request == nil {
		request = NewOfflineResourcePoolRequest()
	}
	response = NewOfflineResourcePoolResponse()
	err = c.Send(request, response)
	return
}
...
func NewAddResourcePoolRequest() (request *AddResourcePoolRequest) {
	request = &AddResourcePoolRequest{
		BaseRequest: &tchttp.BaseRequest{},
	}
	request.Init().WithApiInfo("redis", APIVersion, "AddResourcePool")
	return
}

func NewAddResourcePoolResponse() (response *AddResourcePoolResponse) {
	response = &AddResourcePoolResponse{
		BaseResponse: &tchttp.BaseResponse{},
	}
	return
}
...
// 添加资源池
func (c *Client) AddResourcePool(request *AddResourcePoolRequest) (response *AddResourcePoolResponse, err error) {
	if request == nil {
		request = NewAddResourcePoolRequest()
	}
	response = NewAddResourcePoolResponse()
	err = c.Send(request, response)
	return
}
...
func NewDescribeMachineRequest() (request *DescribeMachineRequest) {
	...
	request.Init().WithApiInfo("redis", APIVersion, "DescribeMachine")
	return
}
...
func NewDisableResourcePoolRequest() (request *DisableResourcePoolRequest) {
	request = &DisableResourcePoolRequest{
		BaseRequest: &tchttp.BaseRequest{},
	}
	request.Init().WithApiInfo("redis", APIVersion, "DisableResourcePool")
	return
}

func NewDisableResourcePoolResponse() (response *DisableResourcePoolResponse) {
	response = &DisableResourcePoolResponse{
		BaseResponse: &tchttp.BaseResponse{},
	}
	return
}
...
// 禁用资源池
func (c *Client) DisableResourcePool(request *DisableResourcePoolRequest) (response *DisableResourcePoolResponse, err error) {
	if request == nil {
		request = NewDisableResourcePoolRequest()
	}
	response = NewDisableResourcePoolResponse()
	err = c.Send(request, response)
	return
}

func NewAddMachineRequest() (request *AddMachineRequest) {
	request = &AddMachineRequest{
		BaseRequest: &tchttp.BaseRequest{},
	}
	request.Init().WithApiInfo("redis", APIVersion, "AddMachine")
	return
}

func NewAddMachineResponse() (response *AddMachineResponse) {
...
// 添加机器
func (c *Client) AddMachine(request *AddMachineRequest) (response *AddMachineResponse, err error) {
	if request == nil {
		request = NewAddMachineRequest()
	}
	response = NewAddMachineResponse()
	err = c.Send(request, response)
	return
}
...
func NewEnableResourcePoolRequest() (request *EnableResourcePoolRequest) {
	request = &EnableResourcePoolRequest{
		BaseRequest: &tchttp.BaseRequest{},
	}
	request.Init().WithApiInfo("redis", APIVersion, "EnableResourcePool")
	return
}

func NewEnableResourcePoolResponse() (response *EnableResourcePoolResponse) {
	response = &EnableResourcePoolResponse{
		BaseResponse: &tchttp.BaseResponse{},
	}
	return
}
...
// 启用资源池
func (c *Client) EnableResourcePool(request *EnableResourcePoolRequest) (response *EnableResourcePoolResponse, err error) {
	if request == nil {
		request = NewEnableResourcePoolRequest()
	}
	response = NewEnableResourcePoolResponse()
	err = c.Send(request, response)
	return
}
...
func NewDescribeResourcePoolsRequest() (request *DescribeResourcePoolsRequest) {
	...
	request.Init().WithApiInfo("redis", APIVersion, "DescribeResourcePools")
	return
}
