...
func NewDescribeSlowLogRequest() (request *DescribeSlowLogRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "DescribeSlowLog")
	return
}
...
func NewRestartInstanceRequest() (request *RestartInstanceRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "RestartInstance")
	return
}
...
func NewDescribeAvailableCharsetRequest() (request *DescribeAvailableCharsetRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "DescribeAvailableCharset")
	return
}
...
func NewDescribeAccountsRequest() (request *DescribeAccountsRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "DescribeAccounts")
	return
}
...
func NewDescribeDBParametersRequest() (request *DescribeDBParametersRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "DescribeDBParameters")
	return
}
...
func NewDescribeInstanceDetailsRequest() (request *DescribeInstanceDetailsRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "DescribeInstanceDetails")
	return
}
...
func NewReleaseIsolatedInstanceRequest() (request *ReleaseIsolatedInstanceRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "ReleaseIsolatedInstance")
	return
}
...
// 本接口 (ReleaseIsolatedInstance) 用于销毁已经隔离的实例。
...
func NewDescribeDbNameListRequest() (request *DescribeDbNameListRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "DescribeDbNameList")
	return
}
...
func NewIsolateInstanceHourRequest() (request *IsolateInstanceHourRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "IsolateInstanceHour")
	return
}
...
// 本接口 (IsolateInstanceHour) 用于隔离后付费实例。
...
func NewModifyDBInstanceSecurityGroupsRequest() (request *ModifyDBInstanceSecurityGroupsRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "ModifyDBInstanceSecurityGroups")
	return
}
...
func NewDescribeDBConfigHistoryRequest() (request *DescribeDBConfigHistoryRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "DescribeDBConfigHistory")
	return
}
...
func NewModifyInstanceSyncTypeRequest() (request *ModifyInstanceSyncTypeRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "ModifyInstanceSyncType")
	return
}
...
func NewDescribeBackupListsRequest() (request *DescribeBackupListsRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "DescribeBackupLists")
	return
}
...
func NewDescribeErrorLogRequest() (request *DescribeErrorLogRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "DescribeErrorLog")
	return
}
...
func NewModifyInstanceNameRequest() (request *ModifyInstanceNameRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "ModifyInstanceName")
	return
}
...
// 本接口（ModifyInstanceName）用于修改实例名。
...
func NewDescribeDBSecurityGroupsRequest() (request *DescribeDBSecurityGroupsRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "DescribeDBSecurityGroups")
	return
}
...
func NewDescribeInstancesRequest() (request *DescribeInstancesRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "DescribeInstances")
	return
}
...
//
// * 可以根据实例ID、实例名称或者实例计费模式等信息来查询实例的详细信息。过滤信息详细请见过滤器Filter。过滤器与实例Id数组不能同时传递。
// * 如果参数为空，则返回当前用户一定数量（Limit所指定的数量，默认为20）的实例。
...
func NewResetAccountPasswordRequest() (request *ResetAccountPasswordRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "ResetAccountPassword")
	return
}
...
func NewDescribeAvailableEngineVersionsRequest() (request *DescribeAvailableEngineVersionsRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "DescribeAvailableEngineVersions")
	return
}
...
func NewCreateInstanceHourRequest() (request *CreateInstanceHourRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "CreateInstanceHour")
	return
}
...
func NewDescribeAvailableZoneConfigRequest() (request *DescribeAvailableZoneConfigRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "DescribeAvailableZoneConfig")
	return
}
...
// 本接口(DescribeAvailableZoneConfig)用于查询云数据库可售卖地域和可用区信息。
...
func NewDescribeUserTasksRequest() (request *DescribeUserTasksRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "DescribeUserTasks")
	return
}
...
func NewSetBackupRulesRequest() (request *SetBackupRulesRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "SetBackupRules")
	return
}
...
func NewDescribeBackupDetailsRequest() (request *DescribeBackupDetailsRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "DescribeBackupDetails")
	return
}
...
func NewDescribeResourceOverviewRequest() (request *DescribeResourceOverviewRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "DescribeResourceOverview")
	return
}
...
func NewRenewInstancesRequest() (request *RenewInstancesRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "RenewInstances")
	return
}
...
func NewDescribeInstanceTaskStatusRequest() (request *DescribeInstanceTaskStatusRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "DescribeInstanceTaskStatus")
	return
}
...
// 本接口（DescribeInstanceTaskStatus）用于查询异步任务的状态。
...
func NewDescribeBackupRulesRequest() (request *DescribeBackupRulesRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "DescribeBackupRules")
	return
}
...
func NewModifyDBParametersRequest() (request *ModifyDBParametersRequest) {
	...
	request.Init().WithApiInfo("tdapg", APIVersion, "ModifyDBParameters")
	return
}
...
// 本接口 (ModifyDBParameters) 用于修改实例参数配置。
